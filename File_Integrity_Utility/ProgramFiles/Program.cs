    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (userChosenMenuOption != 0)
            {
                ...
                {
                    MenuOption6.CompareFilesInGivenFolderToTextFileListingFileNamesFollowedByTheirHashes();
                }
                Console.WriteLine();
        ...
        private static void DisplayMainMenu()
        {
            ...
            Console.WriteLine("    a. That the hashes of all files present match those in the text file.");
        }
